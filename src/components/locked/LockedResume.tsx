...
export function LockedResume() {
  ...
  return (
    ...
    >
      ...
      <section id="about" data-design-id="about.section">
      ...
      <section id="experience" data-design-id="experience.section">
      ...
      <section id="education" data-design-id="education.section">
      ...
      <section id="projects" data-design-id="projects.section">
        <h2 data-design-id="projects.heading">Projects</h2>
        <ul>
      ...
      <section id="skills" data-design-id="skills.section">
      ...
      <section id="achievements" data-design-id="achievements.section">
      ...
      <section id="contact" data-design-id="contact.section">
